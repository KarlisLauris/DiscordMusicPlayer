...
module.exports = {
	...
	async execute(interaction) {
        ...
        if (!voiceChannel) return await interaction.reply({ content: 'You need to be in a voice channel to use this command!', ephemeral: true });
        ...
        if (!connection) return await interaction.reply({ content: 'I am not in a voice channel!', ephemeral: true });
        connection.destroy();
